...
export function getCellColor(cell: CellView): string {
  ...
  switch (cell.type) {
    case CellType.Center:
      return colors.centerCell;
    case CellType.Even:
      return colors.evenCell;
    case CellType.Odd:
      return colors.oddCell;
    default:
      throw Error(`Unsupported celltype: ${cell.type}`);
  }
}
...
export function getCellBorderColor(cell: CellView): string {
  switch (cell.type) {
    case CellType.Center:
      return colors.centerCellBorder;
    case CellType.Even:
      return colors.evenCellBorder;
    case CellType.Odd:
      return colors.oddCellBorder;
    default:
      throw Error(`Unsupported celltype: ${cell.type}`);
  }
}
